---
title: When and How to Paraphrase
layout: home
nav_order: 4
---
...
{: .good-title }
> <span class="emoji-yellow">⚠</span> Good Practice, but better below
>
...
Finally, it should go without saying that even when the author and year of your paraphrased source are mentioned solely in your description, **you should never forget to include the full reference in your text’s list of references**. Failing to do so renders your reference list incomplete, which may result in the downgrading or failure of your assignments. 
