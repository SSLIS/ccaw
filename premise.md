...
[^1]: Some citation styles demand that authors add full-text references in the footnotes (abbreviated with 'ibid.' when repeating a reference), instead of combining in-text parenthetical references with a full list of references. This practice is mostly confined to select disciplines in the traditional Humanities, however, and quite rare in the Social Sciences. 
